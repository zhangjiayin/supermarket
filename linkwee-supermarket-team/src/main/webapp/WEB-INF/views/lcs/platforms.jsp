			    ...
			    <select id="platfrom" class="form-control" placeholder="平台" name="platfrom">
					...
					<c:if test="${!empty selects}">
	    				<c:forEach items="${selects}"  var="select">
	    					<option value="${select.org_number}">${select.org_name}</option>
	    				</c:forEach>
					</c:if>
	        	</select>
			</div>
        ...
        var $db = $(".J_investmentDistributionStatistics").DataTable(
                {
                    ...
                    dom: 'frtip',
                    ajax:{
                        url:"rest/statistics/lcs/team/platforms/investmentDistributionStatistics",
                        type:"POST",
        ...
        var $platfromInvestStatistics = $(".J_platfromInvestStatistics").DataTable(
                {
                    ...
                    dom: 'frtip',
                    ajax:{
                        url:"rest/statistics/lcs/team/platforms/platfromInvestStatistics",
                        type:"POST",
                        dataSrc:function (result) {
