                       ...
                       <li class="start open">
                           <a href="javascript:;">
                               ...
                               <ul class="sub-menu" style="display: block;">
                               	   <li>
                                       <a href="rest/statistics/lcs/dataStatistic" default="javascript:;" id="btn-dashboard" />
                                          	总体数据
                                       </a>
                                   </li>
                                   <li>
                                       <a href="rest/statistics/lcs/teamSaleRecord" default="javascript:;"/>
                                          	团队出单记录
                                       </a>
                                   </li> 
                                   <li>
                                       <a href="rest/statistics/lcs/unRepaymentSaleRecord" default="javascript:;"/>
                                          	信用宝自动在投未赎回记录
                                       </a>
                                   </li>
                                   <li>
                                       <a href="rest/statistics/lcs/search" default="javascript:;"/>
                                          	查找理财师
                                       </a>
                                   </li>
                                   <li>
                                       <a href="rest/statistics/lcs/fouse" default="javascript:;"/>
                                          	我关注的理财师
                                       </a>
                                   </li>
                                   <li>
                                       <a href="rest/statistics/lcs/unsale" default="javascript:;"/>
                                          	近30天未出单理财师
                                       </a>
                                   </li> 
                                    <li>
                                       <a href="rest/statistics/lcsPage" default="javascript:;" />
                                          	理财师信息
                                       </a>
                                   </li>
                                   <li>
                                   ...
                                   <li>
                                       <a href="rest/statistics/lcs/team/platforms" default="javascript:;"/>
                                           	平台分析
                                       </a>
                                   </li>    
                               </ul>
