            ...
            if(is_parent){
                ...
                for(var i=0;i<nodes.length;i++){
                    if(nodes[i].title == title || nodes[i].url == url){
                        ...
                        // linkwee.routerTree = nodes.slice(i);
                        hasnode = true;
                        break;
                    }
                }
...
$(function() {
    ...
    var Index = (function() {
        ...
        //招聘广告
        console.log("是否对互联网金融感兴趣呢?赶紧上车，老司机带你飞。");
        console.log("简历入口 %c caiwei4@tophlc.com （标题格式：“姓名-应聘XX职位-来自console”）","color:red;");
        
        $(".color-blue").trigger("click");
        return me;
    })();
