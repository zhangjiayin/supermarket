...
public class PlatformControllerTest extends BaseTest{
	...
	public void testPlatformPageList() throws Exception {
		...
		BaseResponse baseResponse = TestHelper.remote(AppEnum.CHANNEL_ANDROID,this.getUrl(),"/api/platfrom/pageList",this.getToken(),Map.class,req);
	...
	public void testPcOrgDetail() throws Exception {
		...
		req.setOrgNo("OPEN_FENGHUANGJINRONG_WEB");
		//req.setOrgNo("HUANG");
	...
	public void testOrgDetail() throws Exception {
		OrgDetailRequest req = new OrgDetailRequest();
		req.setOrgNo("OPEN_JIANGONGEDAI_WEB");
		//req.setOrgNo("HUANG");
		BaseResponse baseResponse = TestHelper.remote(AppEnum.CHANNEL_IOS,this.getUrl(PathEnum.LOCALHOST),"/api/platfrom/detail",this.getToken(),OrgInfoResponse.class,req);
		//BaseResponse baseResponse = TestHelper.remote(AppEnum.INVESTOR_IOS,this.getUrl(),"/api/platfrom/detail",this.getToken(),Map.class,req);
		LOGGER.debug(baseResponse.toString());
	}
	/**
	...
	public void testGetOrgProductUrl() throws Exception {
		...
		req.setOrgNo("OPEN_XIAOYINGLICAI_WEB");
		req.setProductId("B169D87E619840169CCCB8759997CECB");
	...
	@Test
	public void getOrgUrlSkipParameterTest() throws Exception {
		OrgUrlSkipParameterRequest req = new OrgUrlSkipParameterRequest();
		req.setOrgNo("OPEN_XIAOYINGLICAI_WEB");
		BaseResponse baseResponse = TestHelper.remote(AppEnum.INVESTOR_IOS,this.getUrl(PathEnum.LOCALHOST),"/api/platfrom/getOrgUrlSkipParameter",this.getToken(),String.class,req);
		LOGGER.debug(baseResponse.toString());
	}
	...
	public static void main(String[] args) {
		 ...
		 String zzz = m.get("haha").toString();
	...
	public void testBindOrgAcct() throws Exception {
		...
		req.setPlatFromNumber("OPEN_XIAOYINGLICAI_WEB");
...
//		parameterMap.put("searchValue", "成国峰");
	 ...
	 */
	@Test
	public void testChoicenessPlatfrom() throws Exception {
		OrgInfoRequest req = new OrgInfoRequest();
		BaseResponse baseResponse = TestHelper.remote(AppEnum.CHANNEL_ANDROID,this.getUrl(PathEnum.LOCALHOST),"/api/platfrom/choicenessPlatform",this.getToken(),Map.class,req);
		LOGGER.debug(baseResponse.toString());
	}
	 ...
	 */
	@Test
	public void testOrgPageList4() throws Exception {
		BaseResponse baseResponse = TestHelper.remote(AppEnum.CHANNEL_ANDROID,this.getUrl(PathEnum.LOCALHOST),"/api/platfrom/orgPageList/4.0",this.getToken(),OrgPageListResponse.class);
		LOGGER.debug(baseResponse.toString());
	}
	
	
	@Test
	public void investedPlatform() throws Exception {
		BaseResponse baseResponse = TestHelper.remote(AppEnum.CHANNEL_ANDROID,this.getUrl(PathEnum.PRERELEASE),"/api/platfrom/investedPlatform/4.0.0",this.getToken(),Map.class);
		LOGGER.debug(baseResponse.toString());
	}
	
	@Test
	public void testOrgRechargeLimitList() throws Exception {
		OrgDetailRequest req = new OrgDetailRequest();
		req.setOrgNo("OPEN_JIANGONGEDAI_WEB");
		BaseResponse baseResponse = TestHelper.remote(AppEnum.CHANNEL_IOS,this.getUrl(PathEnum.LOCALHOST),"/api/platfrom/orgRechargeLimitList/4.1.1",this.getToken(),CimOrgRechargeLimit.class,req);
		LOGGER.debug(baseResponse.toString());
	}
	
	@Test
	public void orgThirdDataDetailTest() throws Exception {
		OrgThirdDataDetailRequest orgThirdDataDetailRequest = new OrgThirdDataDetailRequest();
		orgThirdDataDetailRequest.setOrgNo("OPEN_WUXINGCAIFU_WEB");
		BaseResponse baseResponse = TestHelper.remote(AppEnum.CHANNEL_IOS,this.getUrl(PathEnum.PRERELEASE),"/api/platfrom/orgThirdDataDetail",this.getToken(),OrgThirdDataDetailResponse.class,orgThirdDataDetailRequest);
		LOGGER.debug(baseResponse.toString());
	}
}
