...
public class CustomerControllerTest extends BaseTest{
	...
	public void testMycustomers() throws Exception {
		...
		BaseResponse baseResponse = TestHelper.remote(AppEnum.CHANNEL_ANDROID,this.getUrl(PathEnum.LOCALHOST),"/api/customer/mycustomers/pageList",this.getToken(),Map.class,req);
	...
	public void testHomePage() throws Exception {
		BaseResponse baseResponse = TestHelper.remote(AppEnum.CHANNEL_ANDROID,this.getUrl(PathEnum.LOCALHOST),"/api/customer/homepage",this.getToken(),Map.class);
		LOGGER.debug(baseResponse.toString());
	}
