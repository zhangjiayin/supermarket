...
public class WeiXinMsgTest extends TestSupport {
    ...
    public void testInvestSuccesssendWeiXinMsg() throws NoSuchAlgorithmException, InvalidKeySpecException {
    	...
    	fee1.setFeeamount(new BigDecimal(30));
    	...
    	fee2.setFeeamount(new BigDecimal(10));
    	...
    	fee3.setFeeamount(new BigDecimal(5));
    	//fee3.setGrandParentCfplannerId("3a56eba944334f67bd2f85bf69981a7b");
    	feedetails.add(fee1);
    	feedetails.add(fee2);
    	feedetails.add(fee3);
    	weiXinMsgService.investSuccesssendWeiXinMsg(feedetails,null);
