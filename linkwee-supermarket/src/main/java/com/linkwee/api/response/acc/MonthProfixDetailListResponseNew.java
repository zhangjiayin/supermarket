...
*/
public class MonthProfixDetailListResponseNew implements Serializable
{
	private static final long serialVersionUID = 1L;
	public MonthProfixDetailListResponseNew(){
	}
	public MonthProfixDetailListResponseNew(MonthProfixDetailListResp obj) {
