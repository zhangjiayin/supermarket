...
public class ProductPageList4Response extends BaseEntity {
	...
	public BigDecimal getCouldbuyMoney() {
		if(buyTotalMoney.compareTo(buyedTotalMoney) > 0 && buyMaxMoney != null && StringUtils.isNotBlank(String.valueOf(buyMaxMoney)) && buyMaxMoney.compareTo(new BigDecimal(0)) > 0 && buyTotalMoney.subtract(buyedTotalMoney).compareTo(buyMaxMoney)>= 0){
