...
public class PersonCenterResponse extends BaseEntity {
	...
	public PersonCenterResponse(PersonCenterResp obj) {
		...
		this.setSendNum(obj.getSendNum());
		this.setInvestNum(obj.getInvestNum());
		this.setOnInvestNotReadMsg(obj.getOnInvestNotReadMsg());
		this.setOverdueInvestNotReadMsg(obj.getOverdueInvestNotReadMsg());
	 ...
	 * 在投未读投资记录数目
	 */
	private Integer onInvestNotReadMsg;
	
	/**
	 * 已过期未读投资记录数目
	 */
	private Integer overdueInvestNotReadMsg;	
	...
	public Integer getOnInvestNotReadMsg() {
		return onInvestNotReadMsg;
	}

	public void setOnInvestNotReadMsg(Integer onInvestNotReadMsg) {
		this.onInvestNotReadMsg = onInvestNotReadMsg;
	}

	public Integer getOverdueInvestNotReadMsg() {
		return overdueInvestNotReadMsg;
	}

	public void setOverdueInvestNotReadMsg(Integer overdueInvestNotReadMsg) {
