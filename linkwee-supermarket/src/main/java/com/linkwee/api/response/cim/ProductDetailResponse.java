...
public class ProductDetailResponse extends CimProduct{
	 ...
	 * 可用的加佣券个数
	 */
	private Integer couldUsePersonAddfeeTicketCounts;
	
	private String jfqzProductDetailUrl;
	
	
	public String getJfqzProductDetailUrl() {
		return jfqzProductDetailUrl;
	}

	public void setJfqzProductDetailUrl(String jfqzProductDetailUrl) {
		this.jfqzProductDetailUrl = jfqzProductDetailUrl;
	}
	...
	public Integer getCouldUsePersonAddfeeTicketCounts() {
		return couldUsePersonAddfeeTicketCounts;
	}

	public void setCouldUsePersonAddfeeTicketCounts(
			Integer couldUsePersonAddfeeTicketCounts) {
		this.couldUsePersonAddfeeTicketCounts = couldUsePersonAddfeeTicketCounts;
	}
