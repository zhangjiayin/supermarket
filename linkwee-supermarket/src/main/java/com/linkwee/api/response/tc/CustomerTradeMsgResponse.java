...
public class CustomerTradeMsgResponse extends BaseEntity{
	...
	public Integer getStatus() {
		if(isCollect==null || productStatus==null)
			return 0;
		else 
			return (isCollect==2 && productStatus==1)?1:0;
	}
	...
	public String getLeaderProfit() {
		return leaderProfit==null? "0" : leaderProfit.setScale(2,BigDecimal.ROUND_DOWN).toString();
	}
	...
	public String getRate() {
		...
		return (ObjectUtils.equals(1, isflow))?
			(new BigDecimal(flowMinRate).setScale(2,BigDecimal.ROUND_HALF_UP).toString()+"%".intern())
		: 
			StringUtils.join(new Object[]{new BigDecimal(flowMinRate).setScale(2,BigDecimal.ROUND_HALF_UP).toString()+"%".intern(),new BigDecimal(flowMaxRate).setScale(2,BigDecimal.ROUND_HALF_UP).toString()+"%".intern()},"~".intern());
	}
