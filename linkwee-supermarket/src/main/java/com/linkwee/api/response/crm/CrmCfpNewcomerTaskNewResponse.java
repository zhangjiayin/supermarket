 ...
 */
public class CrmCfpNewcomerTaskNewResponse implements Serializable {
	
	private static final long serialVersionUID = 3734284429588325954L;
	
	public CrmCfpNewcomerTaskNewResponse() {

	}

	public CrmCfpNewcomerTaskNewResponse(CrmCfpNewcomerTask obj) {
