...
public class WeiXinMsgRequest extends BaseEntity{
	 ...
	 * 直接下级理财师手机号
	 */
	private String subordinateCfplannerMobile;
	 ...
	 * 直接管理津贴
	 */
	private String directManagerAllowance;
	
	/**
	 * 团队管理津贴
	 */
	private String teamManagerAllowance;
	
	
	
	public String getDirectManagerAllowance() {
		return directManagerAllowance;
	}

	public void setDirectManagerAllowance(String directManagerAllowance) {
		this.directManagerAllowance = directManagerAllowance;
	}

	public String getTeamManagerAllowance() {
		return teamManagerAllowance;
	}

	public void setTeamManagerAllowance(String teamManagerAllowance) {
		this.teamManagerAllowance = teamManagerAllowance;
	}
	...
	public String getSubordinateCfplannerMobile() {
		return subordinateCfplannerMobile;
	}

	public void setSubordinateCfplannerMobile(String subordinateCfplannerMobile) {
		this.subordinateCfplannerMobile = subordinateCfplannerMobile;
	}
