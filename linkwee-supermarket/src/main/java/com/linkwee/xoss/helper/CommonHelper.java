...
public class CommonHelper {
	 ...
	 * @throws Exception
	 */
	public WeChatConfig getLinghuiquanWeChatConfig(AppTypeEnum appEnum) throws Exception{
		WeChatConfig weChatConfig = new WeChatConfig();
		weChatConfig.setUrlAccessToken(sysConfigService.querySysConfigByKey(SysConfigConstant.TYPE_WECHAT_URL, SysConfigConstant.WECHAT_URL_ACCESS_TOKEN, 0).getConfigValue());
		weChatConfig.setUrlUserInfo(sysConfigService.querySysConfigByKey(SysConfigConstant.TYPE_WECHAT_URL, SysConfigConstant.WECHAT_URL_USER_INFO, 0).getConfigValue());
		weChatConfig.setAppid(sysConfigService.querySysConfigByKey(SysConfigConstant.TYPE_WECHAT, SysConfigConstant.LINGHUIQUAN_WECHAT_APP_ID, appEnum.getKey()).getConfigValue());
		weChatConfig.setAppSecret(sysConfigService.querySysConfigByKey(SysConfigConstant.TYPE_WECHAT, SysConfigConstant.LINGHUIQUAN_WECHAT_APP_SECRET, appEnum.getKey()).getConfigValue());
		return weChatConfig;
	}
