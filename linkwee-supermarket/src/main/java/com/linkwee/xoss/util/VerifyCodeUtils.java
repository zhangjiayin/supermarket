...
public class VerifyCodeUtils{  
    ...
    public static final String PASSWORD_CODES = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
     ...
     * @return 
     */  
    public static String generatePasswordCode(int verifySize){  
        return generateVerifyCode(verifySize, PASSWORD_CODES);  
    }
