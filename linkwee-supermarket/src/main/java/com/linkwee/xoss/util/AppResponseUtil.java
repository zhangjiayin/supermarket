...
public final class AppResponseUtil {
	 ...
	 * 系统异常
	 */
	private static final ErrorResponse errorSystem =  new ErrorResponse("-999999","系统异常");
	 ...
	 * @return
	 */
	public static ErrorResponse getErrorSystem() {
		return errorSystem;
	}
	 ...
	 * @return
	 */
	public static BaseResponse getErrorData(String code,String message){
		ErrorResponse errorData =  new ErrorResponse("100006","数据异常");
		List<BaseResponse> errors = new ArrayList<BaseResponse>();
		errors.add(new BaseResponse(code,message));
