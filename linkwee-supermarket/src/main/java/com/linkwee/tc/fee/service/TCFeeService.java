...
public interface TCFeeService extends GenericService<TCFee,Long>{
	 ...
	 * @return
	 */
	Double queryOfflineFeeByUserId(String userId, String month);
	 ...
	 * @return
	 */
	Double queryLeaderRewardByUserIdNew(String userId, String month);
	 ...
	 * @return
	 */
	Double queryDirectAllowanceByUserId(String userId, String month);
	 ...
	 * @return
	 */
	Double queryTeamAllowanceByUserId(String userId, String month);
