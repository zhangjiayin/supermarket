 ...
 */
public interface DtOrgMoneyInOutWeekMapper extends GenericDao<DtOrgMoneyInOutWeek,Long>{
     ...
     * @return
     */
	List<DtOrgMoneyInOutWeek> selectBySearchInfo(@Param("dt")DataTable dt,RowBounds page);
