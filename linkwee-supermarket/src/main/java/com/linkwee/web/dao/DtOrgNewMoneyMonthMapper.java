 ...
 */
public interface DtOrgNewMoneyMonthMapper extends GenericDao<DtOrgNewMoneyMonth,Long>{
     ...
     * @return
     */
	List<DtOrgNewMoneyMonth> selectBySearchInfo(@Param("dt")DataTable dt,RowBounds page);
