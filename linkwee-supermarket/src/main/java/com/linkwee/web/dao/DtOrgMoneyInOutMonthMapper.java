 ...
 */
public interface DtOrgMoneyInOutMonthMapper extends GenericDao<DtOrgMoneyInOutMonth,Long>{
     ...
     * @return
     */
	List<DtOrgMoneyInOutMonth> selectBySearchInfo(@Param("dt")DataTable dt,RowBounds page);
