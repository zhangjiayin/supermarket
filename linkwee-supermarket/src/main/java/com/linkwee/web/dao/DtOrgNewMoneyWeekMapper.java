 ...
 */
public interface DtOrgNewMoneyWeekMapper extends GenericDao<DtOrgNewMoneyWeek,Long>{
     ...
     * @return
     */
	List<DtOrgNewMoneyWeek> selectBySearchInfo(@Param("dt")DataTable dt,RowBounds page);
