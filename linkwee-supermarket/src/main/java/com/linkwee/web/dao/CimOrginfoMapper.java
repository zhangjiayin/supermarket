...
public interface CimOrginfoMapper extends GenericDao<CimOrginfo,Integer>{
	 ...
	 * 查询短期产品主推平台
	 * @author yalin 
	 * @date 2017年2月28日 下午5:40:09  
	 * @param isGrayUser
	 * @return
	 */
	public List<CimOrginfo> queryShortProductMajorPlatfrom(@Param("isGrayUser")Boolean isGrayUser);
	 ...
	 * @return
	 */
	public List<CimOrginfo> queryMediumAndLongProductMajorPlatfrom(@Param("isGrayUser")Boolean isGrayUser);
	 ...
	 * @return
	 */
	public List<CimOrginfo> queryHighYieldProductPlatfrom(@Param("isGrayUser")Boolean isGrayUser);
	...
	/**
	 * 查询机构列表4.0
	 * @param orgPageList4Request
	 * @param page
	 * @return
	 */
	public List<OrgPageListResponse> queryOrgPageList4(OrgPageList4Request orgPageList4Request,Page<OrgPageListResponse> page);
	 ...
	 * @return
	 */
	public Map<String, String> investStatistics(@Param("userId")String userId,@Param("isGrayUser")Boolean isGrayUser);
	 ...
	 * @return
	 */
	public List<InvestStatisticsResponse> platformInvestStatistics(@Param("userId")String userId,@Param("isGrayUser")Boolean isGrayUser);
	 ...
	 * @return
	 */
	public String totalProfit(@Param("userId")String userId,@Param("isGrayUser")Boolean isGrayUser);
	 ...
	 * @return
	 */
	public List<InvestProductStatisticsResponse> investProductStatistics(@Param("userId")String userId,@Param("isGrayUser")Boolean isGrayUser);
}
