...
public class ClassroomServiceImpl extends GenericServiceImpl<Classroom, Long> implements ClassroomService{
	...
	@Override
	public Classroom queryNewest(Integer appType) {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("appType", appType);
		return classroomMapper.queryNewest(map);
	}

	@Override
	public List<Classroom> selectedRecomendList() {
		return classroomMapper.selectedRecomendList();
	}

	@Override
	public Classroom queryMorningPaper() {
		return classroomMapper.queryMorningPaper();
	}
