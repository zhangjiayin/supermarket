...
public interface AcBalanceRecordService extends GenericService<AcBalanceRecord,Long>{
	 ...
	 * @return
	 */
	PaginatorResponse<AcBalanceRecord> queryAllAccountDetails(Page<AcBalanceRecord> page,
			Map<String, Object> conditions);
	 ...
	 * @return
	 */
	PaginatorResponse<MonthProfixDetailListResp> queryMonthProfixDetailListNew(MonthProfixDetailRequestNew req,
			Page<MonthProfixDetailListResp> page);
	 ...
	 * @return
	 */
	PaginatorResponse<MonthProfixTotalListResp> queryProfixTotalListNew(MonthProfixDetailRequest req,
			Page<MonthProfixTotalListResp> page);
     ...
     * 奖励收入
     */
	Double queryRewardIncome(String userId);
	
	/**
     * 奖励支出
     */
	Double queryRewardOut(String userId);

	/**
     * 账户明细4.5.4版本
     */
	PaginatorResponse<AccountBalanceListResp> accountBalanceDetails(String userId,
