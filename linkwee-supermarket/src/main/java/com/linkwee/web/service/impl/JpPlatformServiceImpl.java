...
public class JpPlatformServiceImpl extends GenericServiceImpl<JpPlatform, Long> implements JpPlatformService{
	...
	public PaginatorResponse<JpPlatform> queryPlatformList(Page<JpPlatform> page,Map<String,Object> conditions){
		...
		String jpress_domain = systemConfigService.getValuesByKey(WebConstants.JPRESS_SERVER_URL); 
		if(StringUtils.isNotBlank(jpress_domain) && jpress_domain.endsWith("/") ) jpress_domain  = jpress_domain.substring(0,jpress_domain.length()-1);
