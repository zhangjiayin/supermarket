...
public class SmBrandPromotionServiceImpl extends GenericServiceImpl<SmBrandPromotion, Long> implements SmBrandPromotionService{
	...
	@Override
	public List<SmBrandPromotion> selectAllListByCondition(SmBrandPromotion smBr) {
		return smBrandPromotionMapper.selectAllListByCondition(smBr);
	}

	@Override
	public List<SmBrandPostersType> selectAllBrandPostersTypeList() {
		return smBrandPromotionMapper.selectAllBrandPostersTypeList();
	}

	@Override
	public List<SmBrandPromotion> selectBrandPostersList(SmBrandPromotion smBr) {
		return smBrandPromotionMapper.selectBrandPostersList(smBr.getAppType());
	}
