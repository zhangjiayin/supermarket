...
import com.linkwee.web.service.DtOrgMoneyInOutMonthService;
 /**
 * 
 * @描述： DtOrgMoneyInOutMonthService服务接口
 * 
 * @创建人： liqimoon
 * 
 ...
 */
public interface DtOrgMoneyInOutMonthService extends GenericService<DtOrgMoneyInOutMonth,Long>{

	/**
	 * 查询DtOrgMoneyInOutMonth列表,为data-tables封装
	 * @param dataTable
	 * @return
	 */
