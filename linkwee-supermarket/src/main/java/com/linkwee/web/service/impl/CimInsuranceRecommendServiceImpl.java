...
public class CimInsuranceRecommendServiceImpl extends GenericServiceImpl<CimInsuranceRecommend, Long> implements CimInsuranceRecommendService{
	...
	@Override
	public List<CimInsuranceProductExtends> getInsuranceProductByType(String category, String queryType) {
		// TODO Auto-generated method stub
		return cimInsuranceRecommendMapper.getInsuranceProductByType(category,queryType);
	}
