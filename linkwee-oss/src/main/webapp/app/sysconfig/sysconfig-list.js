...
$(document).ready(function() {
    ...
    var table = $('#dtable').DataTable( {
        ...
        "columns": [
            ...
            { "data": "crtTime" ,"orderable": false,"render":function(data,type,row){return new Date(data).Format("yyyy-MM-dd hh:mm:ss")}},
            { "data": "appType","orderable": false,"render": function ( data, type, row ) {
          	   //0公用，1理财师，2投资者
          	   if(data==0)return "公用"
          	   if(data==1)return "理财师"
          	   if(data==2)return "金服投资者"
             }},
