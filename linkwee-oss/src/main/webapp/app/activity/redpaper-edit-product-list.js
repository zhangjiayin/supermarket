										...
										columns : [
												...
												},
												{
													...
													render : function(data,type, row) {
														var isBinding = milo.hasValue(window['bindignProductIds'],row.productId||"");
														if(isBinding){
															 return $("<a>").html('<p class="text-muted">取消绑定</p>').attr({'href' : 'javascript:;'})[0].outerHTML;
														}else{
															isBinding = milo.hasValue(window['rproductIds'],row.productId);
