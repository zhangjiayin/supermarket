...
$(document).ready(function() {
    ...
    var table = $('#dtable').DataTable( {
    	width: 800,
    	dom : '<"J_redpaperEveryDayCal_toolbar">frtip',
        ...
        "ajax": {
			...
			"data" : function(d) {
				d.date = $('.J_redpaperEveryDayCal_toolbar input[name=date]').val();
    ...
    $(".J_redpaperEveryDayCal_toolbar").html(
			$("#template-search").html());
	$("a.J_redpaperEveryDayCal_search").click(function() {
		table.draw();
	});
