...
<!-- 		<div class="prdAdd">
		...
		<div class="prdAdd">
			...
			<span class="rightsp"><input class="easyui-numberbox" type="text" name="custBuyMaxMoney" data-options="precision:2">
		...
		<div class="prdAdd">
			...
			<span class="rightsp">
			<input class="easyui-numberbox" type="text" name="collectLineMinValue" data-options="required:true" id="collectLineMinValue"> ~ <input class="easyui-numberbox" type="text" name="collectLineMaxValue" id="collectLineMaxValue" data-options="required:true">天
			<form:errors path="custBuyMaxMoney" cssClass="error" /> 
			</span>
		</div>
		...
		<!-- 	<input name="interestWayType" type="radio"  value="1" checked="checked"> -->
			募集完成后<select name="interestWay">
			<%-- <c:forEach var="item" begin="0" end="1" step="1">
		   ...
		   <option value="2">T+1</option>
			...
			<!--  <input class="easyui-validatebox"  name="validBeginDate"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"  style="width:150px" > -->
			</span>
		</div>
		...
		<div class="prdAdd">
			...
			<span class="rightsp"><input class="easyui-validatebox"  name="collectEndTime" id="collectEndTime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"  style="width:150px" data-options="required:true">
			</span>
		</div>
		<div class="prdAdd">
    ...
    <legend>金服端信息</legend>
		...
		<div class="prdAdd">
			...
			<span class="rightsp">
				<input  class="easyui-validatebox"  type="text" name="ransferProtocalName"  id="ransferProtocalName" placeholder="协议名称" data-options="required:true">
				<input  class="easyui-validatebox"  type="text" name="ransferProtocalUrl"  id="ransferProtocalUrl" placeholder="协议地址" data-options="required:true">
		...
		<div class="prdAdd">
			...
			<!-- <input  class="easyui-validatebox"  type="text" name="productProtocalName" data-options="required:true"  id="productProtocalName" placeholder="协议名称"> -->
				<!-- <input  class="easyui-validatebox"  type="text" name="productProtocalId"   id="productProtocalId" placeholder="协议地址"> -->
    ...
    <div class="prdAdd">
			...
			<span class="rightsp"><input  name="endSaleTime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  style="width:150px"  >
			</span>
	</div>
    </fieldset>
