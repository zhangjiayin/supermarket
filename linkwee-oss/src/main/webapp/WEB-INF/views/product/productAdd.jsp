...
<!-- 		<div class="prdAdd">
		...
		<div class="prdAdd">
			...
			<span class="rightsp">
			<div id="collectInterestWayDiv" style="display: inline;" >
			...
			<option value='2'>T+1</option>
			 ...
			 <div id="validBeginDateDiv" style="display: inline;">
...
<!-- 		<div style="padding-top: 30px;text-align:center;width: 90%;">
		...
		<div id="raiseInfoDiv" style="display: none;">
			...
			<span class="rightsp"><input class="easyui-validatebox"  name="collectEndTime" id="collectEndTime"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"  style="width:150px" >
			</span>
		</div>
		<div class="prdAdd">
    ...
    <legend>金服端信息</legend>
		...
		<div class="prdAdd">
			...
			<!-- <input  class="easyui-validatebox"  type="text" name="productProtocalName" data-options="required:true"  id="productProtocalName" placeholder="协议名称"> -->
			    ...
			    <option value="${item.id }">${item.protocalFileUrl }</option>
				</c:forEach>
				</select>
    ...
    <div class="prdAdd">
			...
			<span class="rightsp">
				...
				<div id="preSaleDiv" style="display: inline;">
