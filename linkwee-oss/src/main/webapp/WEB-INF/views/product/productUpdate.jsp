...
<%-- 		<div class="prdAdd">
		...
		<div class="prdAdd">
			...
			</select>起息&nbsp;&nbsp; <div id="validBeginDateDiv" style="display: inline;">
...
<%-- 		<div style="padding-top: 30px;text-align:center;width: 90%;">
		...
		<div id="raiseInfoDiv" style="display: <c:if test="${dtl.isCollect eq 1}">none</c:if><c:if test="${dtl.isCollect eq 2}">inline</c:if>;">
			...
			<span class="rightsp"><input class="easyui-validatebox"  id="collectEndTime" name="collectEndTime"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"  style="width:150px"  value="<fmt:formatDate value="${dtl.collectEndTime }" pattern="yyyy-MM-dd" />">
			</span>
		</div>
		<div class="prdAdd">
    ...
    <legend>金服端信息</legend>
		...
		<div class="prdAdd">
			...
			<input  class="easyui-validatebox"  type="text" name="ransferProtocalName"  id="ransferProtocalName" placeholder="协议名称" value="${dtl.ransferProtocalName }" data-options="required:true">
				<input  class="easyui-validatebox"  type="text" name="ransferProtocalUrl"  id="ransferProtocalUrl" placeholder="协议链接" value="${dtl.ransferProtocalUrl }" data-options="required:true">
		...
		<%-- 		<input  class="easyui-validatebox"  type="text" name="productProtocalId"   placeholder="协议链接" id="productProtocalId" value="${dtl.productProtocalId }"> --%>
