...
<%-- 		<div style="padding-top: 30px;text-align:center;width: 90%;">
		...
		<div id="raiseInfoDiv" style="display: <c:if test="${dtl.isCollect eq 1}">none</c:if><c:if test="${dtl.isCollect eq 2}">inline</c:if>;">
			...
			<span class="rightsp"><input class="easyui-validatebox"  name="collectEndTime" id="collectEndTime" disabled="disabled" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"  style="width:150px"  value="<fmt:formatDate value="${dtl.collectEndTime }" pattern="yyyy-MM-dd" />">
			</span>
		</div>
		<div class="prdAdd">
    ...
    <legend>金服端信息</legend>
		...
		<div class="prdAdd">
			...
			<input  class="easyui-validatebox"  type="text" name="ransferProtocalName"  id="ransferProtocalName" placeholder="协议名称" value="${dtl.ransferProtocalName }" data-options="required:true">
				<input  class="easyui-validatebox"  type="text" name="ransferProtocalUrl"  id="ransferProtocalUrl" value="${dtl.ransferProtocalUrl }" data-options="required:true">
		...
		<div class="prdAdd">
			...
			<%-- <input  class="easyui-validatebox"  type="text" name="productProtocalName" data-options="required:true"  id="productProtocalName" placeholder="协议名称" value="${dtl.productProtocalName }"> --%>
				<%-- <input  class="easyui-validatebox"  type="text" name="productProtocalId"   id="productProtocalId" value="${dtl.productProtocalId }"> --%>
...
<!-- 		<div class="prdAdd">
		...
		<input name="opType" type="hidden" value="edit" />
	</form>
