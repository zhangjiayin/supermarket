...
<div id="main-customerx" class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-4">
            <c:if test="${!empty cfp}"><p id="cfpinfo">理财师：${cfp.name} ${cfp.mobile}</c:if> </p>
        </div>
    </div>
    ...
    <script type="text/javascript">
        var $dataTable = $("#custome-list-table").DataTable({
            ...
            serverSide:true,
            ajax:{
                url:'rest/cfprelevant/customelist_json',
                type:"POST",
            ...
            columnDefs:[
                {
                  ...
                  targets:4,
                    data:"orgName",
                    render:function(data,type,full,meta){
                        //0001=钱罐子,0002=众筹,0003=领会金服,0004=新财富
                        switch (data){
                            case '0001':
                                    return '钱罐子';
                                break;
                ...
                },
                {
                    ...
                    data:"idCard",
                    render:function (data,type,full,meta) {
                        return data?data.substring(0,data.length-4)+'****':"<a  style='color: red;'>--</a>";
                    }
                },
                {
                    targets:10,
