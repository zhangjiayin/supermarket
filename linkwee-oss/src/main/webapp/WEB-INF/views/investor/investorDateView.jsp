...
<table>
 <tr>
  ...
  <tr>
   ...
   <tr>
    <th align="center">投资客户总计：<div id="totalperson" style="display: inline;">${total.totalperson}</div>人</th>
    <th align="center">年化成交总额：<div id="totalmoney" style="display: inline;">${total.totalmoney}</div></th>
  </tr>
   <tr>
 ...
 function loadView(){
	 ...
	 $.getJSON('rest/invest/statdata',params, function (json) {
