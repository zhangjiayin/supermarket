...
<div id="main-news" class="container-fluid">
    <div class="table-responsive">
        <table id="J-newslist" class="table table-bordered" data-defer="false" data-xtoolbars="#template-search" data-url="rest/customerInvest/investRecordlist?customerId=${customerId}" data-order="false" data-paging="true" data-size="10">
            <thead>
                <tr>
