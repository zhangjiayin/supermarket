...
<input type="hidden" id="operator" value="${userInfo.username}" />
	...
	<div class="row">
		...
		<table style="border:1px solid #dcdcdc; text-align: center;">
		  <tr style="border:1px solid #dcdcdc;">
		    ...
		    <th style="border:1px solid #dcdcdc;" width="160px">发放的红包数量</th>
		    <th style="border:1px solid #dcdcdc;" width="160px">发红包的客户数量</th>
	...
	<div class="row">
			...
			<c:if test="${redpaperUserInfo.limitInvestProduct==2}">
				 <p style="color: red;">仅特定产品才能使用该红包：</p>
					<div class="uk-blank"></div>
						<table style="border:1px solid #dcdcdc; text-align: center;">
						  <tr style="border:1px solid #dcdcdc;">
						    <th style="border:1px solid #dcdcdc;" width="160px">产品类型</th>
						  ...
						  <c:forEach var="product" items="${ps}">
							  <tr style="border:1px solid #dcdcdc;">
							    <td style="border:1px solid #dcdcdc;" width="100px">${product.productTypeId}</td>
