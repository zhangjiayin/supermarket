...
<div class="container-fluid">
	<div class="row">
		...
		<div class="uk-blank" />
		<div class="col-md-1">
			<button type="button" class="btn btn-primary" id="productSubmit">更新红包信息</button>
		</div>
	</div>
...
<script type="text/javascript" src="app/activity/redpaper-edit-product-list.js"></script>
</div>
