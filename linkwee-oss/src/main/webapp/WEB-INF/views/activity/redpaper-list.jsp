                            ...
                            <div class="modal-body">
                                <form role="form"  method="post" id="myForm">
	                                <div class="form-group">
										  <label>
										     <input type="radio" name="lcsType" value="all" checked>所有理财师&nbsp&nbsp<span style="color: red;font-size: 10px;">发放时间较长(3-5分钟)，慎用！</span>
										  </label>
									</div>
									  ...
									  <div class="form-group">
										  <label>
										     <input type="radio"  name="lcsType" value="importlcs">导入理财师名单发放红包 <span style="color: red;font-size: 10px;">推荐！仅支持xls文件。&nbsp&nbsp<a href="<%=path %>/rest/redpaper/downloadImportTemplate">下载导入模板</a></span>
										  </label>
										   
										  <div id="uploadLcsForm" style="display: none;">
										    <input id="fileLcs" type="file" name="file" />
										</div>
									  </div>
									  <div class="form-group">
										 
										   <label>
										     <input type="radio"  name="lcsType" value="importInvestor">导入金服用户名单发放红包 <span style="color: red;font-size: 10px;">仅支持xls文件，最高不超过10000条。&nbsp&nbsp<a href="<%=path %>/rest/redpaper/downloadImportTemplate">下载导入模板</a></span>
										  </label>
										  
										  <div id="uploadInvestorForm" style="display: none;">
										    <input id="fileInvestor" type="file" name="file" />
										</div>
									  </div>
	                                   <div class="form-group">
	                                    	<label class="control-label">发放数量</label>&nbsp&nbsp<span style="color: red;font-size: 10px;">每次最多发5个</span>
	                                        <input type="text" class="form-control" name="sendNums" placeholder="为每位用户发放多少个红包">
	                                    </div>
