...
public class RedPacketInfoRequest implements Serializable{
	...
	private Double maxMoney;//最大投资金额  仅limitMoney=1有效 
	private Double minMoney;//最小投资金额  仅limitMoney=1有效
	...
	public Integer getLimitInvestUser() {
		return limitInvestUser;
	}

	public void setLimitInvestUser(Integer limitInvestUser) {
		this.limitInvestUser = limitInvestUser;
	}
