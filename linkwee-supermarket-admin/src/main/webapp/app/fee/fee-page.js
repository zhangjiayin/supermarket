$(document).ready(function() {
    ...
    $(".J_fee_model").on("click",function(evnet){
    	layer.confirm('如果已经计算则可直接发放,如果已经发放则只显示发放佣金数据,确定执行佣金计算？', {btn: ['确定','取消'],title:'系统提示',icon: 3}, function(index){
    		$.ajax({
    			...
    			success : function(data) {
    				...
    				$modal.find(".modal-title").html("发放佣金确认提示");
