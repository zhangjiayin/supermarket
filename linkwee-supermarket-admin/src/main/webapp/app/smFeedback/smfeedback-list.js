...
$(document).ready(function() {
    ...
    $.ajax({  
        url: '/rest/sm/smfeedback/userPermission' ,  
        type: 'POST',  
        data: null,  
        async: false,  
        cache: false,  
        ...
        success: function (data) { 
        	if(data.feebackEditPermission == '0'){
        		table.buttons().disable();
                table.buttons('.buttons-create').nodes().css( 'display', 'none' );
                table.buttons('.buttons-edit').nodes().css( 'display', 'none' );
                table.buttons('.buttons-remove').nodes().css( 'display', 'none' );
        	}       	
        },  
