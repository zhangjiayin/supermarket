...
$(document).ready(function() {
    editor = new $.fn.dataTable.Editor( {
    	ajax: {
            create: {
                type: 'POST',
                url:  'rest/cim/actpersonaddfeeticketsendusedetail/save',
    ...
    var table = $('#dtable').DataTable( {
        ...
        "ajax": {
            "url": "/rest/cim/actpersonaddfeeticketsendusedetail/list",
            "type": "POST",
        ...
        "columns": [
            ...
            { "data": "ticketId","orderable": false },
            { "data": "ticketSendId","orderable": false },
            { "data": "investId","orderable": false },
            { "data": "feeAmount","orderable": false },
            { "data": "addFeeDay","orderable": false },
            ...
            { "data": "investUseTime","orderable": false },
