...
$(document).ready(function() {
    editor = new $.fn.dataTable.Editor( {
    	ajax: {
            create: {
                type: 'POST',
                url:  'rest/cim/cimorgfresgradetype/save',
    ...
    editor.on( 'preSubmit', function ( e, o, action ) {
        if ( action !== 'remove' ) {
            var name = editor.field( 'fresName' );
    ...
    var table = $('#dtable').DataTable( {
        ...
        "ajax": {
            "url": "/rest/cim/cimorgfresgradetype/list",
            "type": "POST",
            "data":function(d){return {'_dt_json':JSON.stringify(d)};}//传递对象太多，json化
        },
        "columns": [
            { "data": "id","orderable": false },
            { "data": "fresNumber","orderable": false },
            { "data": "fresName","orderable": false },
            { "data": "fresSort","orderable": false },
            { "data": "fresFullScore","orderable": false },
