...
<div>
    <div class="table-responsive">
      ...
      <script type="text/javascript">
        ...
        var doFCT = function (data,type,full,meta) {
	        ...
	        var edit = '<shiro:hasPermission name="<%=PermissionSign.PRODUCT_CATE_EDIT%>">'+'<button class="btn btn-sm btn-default btn-icon J_productCateEdit" data-title="产品分类编辑" data-id='+full.cateId+'><i class="fa fa-edit" ></i>编辑</button></shiro:hasPermission>';
            return edit;
        }
    ...
    <script type="text/linkwee-template" id="template-search">
			...
			<shiro:hasPermission name="<%=PermissionSign.PRODUCT_CATE_EDIT%>">
