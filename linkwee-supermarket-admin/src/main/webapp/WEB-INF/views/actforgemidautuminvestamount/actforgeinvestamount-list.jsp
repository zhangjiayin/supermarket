...
<div id="main-forgeinvestamount" class="container-fluid">
    <div class="table-responsive">
        <table id="J-forgeinvestamountList" class="table table-bordered" data-defer="false" data-xtoolbars="#template-search" data-url="rest/act/actforgemidautuminvestamount/list_ajax" data-order="false" data-paging="true" data-size="10">
            <thead>
                <tr>
    ...
    <script type="text/javascript">
        ...
        var cumsDetail = function (data,type,full,meta) {
        	return '<a class="btn btn-sm btn-default btn-icon ui-redirect" href="javascript:;" data-title="资讯编辑" data-url="/rest/act/actforgemidautuminvestamount/tosave?id='+data+'" ><i class="fa fa-edit"></i>编辑</a> &nbsp;&nbsp;<a class="btn btn-sm btn-danger btn-icon J_forgeinvestamount_delete" data-id="'+data+'" href="javascript:;"><i class="fa fa-trash-o"></i>删除</a>'; 
        }
        ...
        $("#main-forgeinvestamount").delegate("a.J_forgeinvestamount_delete","click",function () {
            ...
            bootbox.confirm("确定要执行删除操作吗？",function (result) {
                if(result){
                    $.get("rest/act/actforgemidautuminvestamount/del",{id:iid},function (result) {
                        if(result.isFlag){
                            $db.draw();
                        }
                    });
                ...
                <div class="col-sm-3">
                    <div class="input-group">
                        <span class="input-group-btn">                           
                            <a class="btn btn-default btn-icon ui-redirect" href="javascript:;" data-title="添加数据" data-url="/rest/act/actforgemidautuminvestamount/tosave" role="button"><i class="fa fa-plus"></i>添加数据</a>
                        </span>
                    </div>
                </div>
            </div>
