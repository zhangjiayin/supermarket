        ...
        var $db = $("#J-invest_list").DataTable(
                {
                    ...
                    columns:[
                        ...
                        {data:"userId",render: function ( data, type, row ) {
                        	...
                        	var platfromText = $('#platfrom').find("option:selected").text();
                            var url ='rest/invest/getCustomerInvestDetailPage?userId='+row.userId+'&name='+row.name+'&mobile='+row.mobile+'&platfrom='+platfrom+'&platfromText='+platfromText;
                            return '<a class="btn btn-link ui-redirect " data-title="投资详情" data-url="'+url+'">查看投资详情</a>';
                         }} */
                    ],
                    columnDefs:[  ],
                    language:{
    ...
    <script type="text/linkwee-template" id="template-search">
            <div class="row">
                <div class="col-xs-8">
					...
					<button class="btn btn-default btn-sm J_search" role="button" style="margin-left: 20px;">查询</button>
				</div>
				 <div class="col-xs-2 col-xs-offset-2">
					<button class="btn btn-link ui-redirect" data-url="rest/invest/investmentDistributionStatisticsPage" data-title="投资分布" role="button" style="margin-left: 20px;">投资分布</button>
				</div>
   			</div>
    </script>
</div>
