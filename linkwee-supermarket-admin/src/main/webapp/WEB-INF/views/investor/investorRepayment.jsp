        ...
        <script type="text/linkwee-template" id="template-search">
            ...
            <div class="row">
                ...
                <div class="col-xs-2">
 				...
 				<div class="col-xs-1">
					<button class="btn btn-default J_search" role="button" style="margin-left: 20px;">查询</button>
				</div>
				<shiro:hasPermission name="<%=PermissionSign.RECENT_REPAYMENT_EXPORT%>">
        ...
        var $db = $("#J-InvestorRepayment_list").DataTable(
                {
                    ...
                    columns:[
                        ...
                        {data:"investorId",render: function ( data, type, row ) {
                            ...
                            return '<button class="btn btn-link ui-redirect " data-title="投资详情" data-url="'+url+'">查看投资详情</button>';
                         }}
                    ],
                    columnDefs:[  ],
                    language:{
