...
<div class="form-group" id="team-${param.teamindex}">
	...
	<div class="row">
		 <div class="col-md-2">
				<div class="kv-avatar center-block" style="width:200px">
					<input type="file" class="uploadHead" data-md5="e9cc38a97c6284d096d0cbbf8d0aafa7?f=png" data-errors="team-errors-${param.teamindex}" data-validateerrors="team-head-img-${param.teamindex}" />
				</div>
				<div class="form-group" style="text-align: center;">
					<input id="team-head-img-${param.teamindex}" name="teams_team${param.teamindex}.orgHeadImg" type="hidden" required/>
				</div>
		</div>
 ...
 <script id="templatejs" type="text/javascript" src="app/cimorginfounrecord/headupload.js"></script>