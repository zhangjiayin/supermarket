...
<div id="main-news" class="container-fluid">
    ...
    <script type="text/javascript">
	    ...
	    var doFCT = function (data,type,full,meta) {
	      	...
	      	var a = '<a class="btn btn-default btn-sm ui-redirect" data-title="查看" data-url="/rest/crmSalesOrg/view?id=' + data +'">查看</a>';
	      	var b = '<a class="btn btn-default btn-sm ui-redirect" data-title="编辑" data-url="/rest/crmSalesOrg/editPage?id=' + data +'">编辑</a>';
	      	var c = '<a class="btn btn-default btn-sm ui-redirect" data-title="导入" data-url="/rest/crmSalesOrg/importPage?salesOrgId='+ full.salesOrgId +'">导入理财师</a>';
	        return a+b+c;
	    }
