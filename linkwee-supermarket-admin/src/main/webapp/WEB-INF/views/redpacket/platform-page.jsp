...
<script type="text/javascript" >  window['platformIds']  =eval('${ids}') ; var redPacketTemplateId = '${redpacketId}';</script>
...
<table id="platform-list" class="table table-bordered" cellspacing="0" width="100%">
	...
	$(document).ready(function() {
        var bindingClass = 'btn btn-default btn-sm J_platformId bind';
        var unbindingClass = 'btn btn-danger btn-sm J_platformId unbind';
		...
		//deferLoading:false,
	        ...
	        "ajax": {
	            ...
	            "data":function(d){
                      ...
                      d.redPacketTemplateId = redPacketTemplateId;
                      debugger;
                      d.columns = [];
                      d.search = {};
