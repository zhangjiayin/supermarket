	...
	<div class="row">
		<div class="col-sm-10">
			...
			<form id="editClassForm" action="rest/acc/smclassroom/save" method="post">
				...
				<div class="form-group">
					<label>标题</label>
					<input name="title" type="text" class="form-control" value="${classroom.title}" placeholder="请输入标题"  />
				</div>
				...
				<div class="form-group">
					...
					<select  name="label" class="form-control">
						<option <c:if test="${(not empty requestScope.classroom and requestScope.classroom.label eq '今日财经早知道')  }"> selected="selected"</c:if> value="今日财经早知道">今日财经早知道</option>
						<option <c:if test="${(not empty requestScope.classroom and requestScope.classroom.label eq '新版猎财攻略')  }"> selected="selected"</c:if> value="新版猎财攻略">新版猎财攻略</option>
					</select>
				</div>
