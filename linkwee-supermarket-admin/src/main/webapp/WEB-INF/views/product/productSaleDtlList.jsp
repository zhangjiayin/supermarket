    ...
    <div id="proSaleDtlToolbar"style="display: none;">
        <div>
        	...
        	<input name="buyUserId"   style="width:110px" id="buyUserId" placeholder="投资者姓名" >
		        ...
		        <a id="proSaleDtlQueryButton" class="easyui-linkbutton" >&nbsp;&nbsp;查 询&nbsp;&nbsp;</a>
		        <a id="retBtn"  class="easyui-linkbutton">&nbsp;&nbsp;返回&nbsp;&nbsp;</a> 
		        <!-- <a id="proSaleDtlExcelButton" class="easyui-linkbutton" >导出EXCEL</a> -->
	        </form>
        </div>
    </div>
