...
<div id="main-productEdit" class="container-fluid">
    ...
    <script type="text/javascript">       
        var productEdit_opts  = function (data,type,full,meta) {
              return '<shiro:hasPermission name="<%=PermissionSign.PRODUCT_DETAIL_EDIT%>">'+'<a class="btn btn-sm btn-default btn-icon ui-redirect" href="javascript:;" data-title="资讯编辑" data-url="/rest/cim/cimproductedit/tosave?id='+data+'" ><i class="fa fa-edit"></i>编辑</a> &nbsp;&nbsp;<a class="btn btn-sm btn-danger btn-icon J_productEdit_delete" data-id="'+data+'" href="javascript:;"><i class="fa fa-trash-o"></i>删除</a></shiro:hasPermission>';
        }
    ...
    <script type="text/linkwee-template" id="template-search">
        <form>
            <div class="row">
				...
				<shiro:hasPermission name="<%=PermissionSign.PRODUCT_DETAIL_EDIT%>">
					<div class="col-sm-3">   
