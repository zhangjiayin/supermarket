...
easyloader.modules.my97DatePicker = {
    ...
    <div id="newsToolbar"style="display: none;">
		...
		<c:forEach var="item" items="${newsTypeList }" varStatus="dn">
			...
			<button id="newsQueryButton" class="easyui-linkbutton">&nbsp;&nbsp;查
				询&nbsp;&nbsp;</button> <button data-id="newsAddBtn"  class="easyui-linkbutton ui-redirect" data-title="新增资讯" data-url="/rest/news/tosave">新增</button>
		</form>
	</div>
    </div>
