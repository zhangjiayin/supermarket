...
<c:if test="${!empty dtl}">
	...
	<div class="row">
		...
		<div class="row">
			<div class="col-sm-8"><span>职级：</span><span>${dtl.jobGrade}</span></div>
			<shiro:hasPermission name="<%=PermissionSign.LCS_LEVEL_UPDATE%>">
			<div class="col-sm-4"><a class="btn btn-primary J_changeJobGrade" href="rest/lcsList/changeCFPJobGrade/${dtl.mobile}">变更当前职级</a></div>
			</shiro:hasPermission>
		</div>
		<div class="uk-blank"></div>
...
<script type="text/javascript">
	...
	// 职级记录
	$("a.J_changeJobGrade").click(function () {
			$.get($(this).attr("href"),{},function (html) {
				cfpJobGradedialog = bootbox.dialog({
					message:html,
					title:"变更职级"
				});
			},"html");
