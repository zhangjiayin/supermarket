...
<c:if test="${!empty dtl}">
	...
	<div class="row">
		...
		<div class="uk-blank"></div>
		<div class="row">
			<div class="col-sm-6"><span>年龄：</span><span>${dtl.age}</span></div>
			<div class="col-sm-6"></div>
		</div>
		
		<div class="uk-blank"></div>
		<div class="row">
			<div class="col-sm-6"><span>手机号归属地：</span><span>${dtl.city}</span></div>
			<div class="col-sm-6"></div>
		</div>
		
		<div class="uk-blank"></div>
		<div class="row">
			<div class="col-sm-6"><span>最后一次登陆时间：</span><span><fmt:formatDate value="${dtl.rectVisitTime}" pattern="yyyy-MM-dd HH:mm:ss" /></span></div>
			<div class="col-sm-6"></div>
		</div>
		...
		<div class="row">
			...
			<c:if test="${!empty dtl.headImage}">
			<img src="${dtl.headImage}" class="img-thumbnail" width="200" />
			</c:if>
			</div>
			<div class="col-sm-6"></div>
		</div>
...
<br>
		<table style="border:1px solid #dcdcdc;">
		  <tr style="border:1px solid #dcdcdc;">
		    <td style="border:1px solid #dcdcdc;" width="100px">红包金额（元）</td>
		    <td style="border:1px solid #dcdcdc;" width="100px">投资金额限制（元）</td>
		    <td style="border:1px solid #dcdcdc;" width="100px">适用平台</td>
		    <td style="border:1px solid #dcdcdc;" width="100px">适用产品</td>
		    <td style="border:1px solid #dcdcdc;" width="100px">首投限制</td>
		    <td style="border:1px solid #dcdcdc;" width="100px">红包过期时间</td>
		  </tr>
		</table>
...
<br>
		<table style="border:1px solid #dcdcdc;">
		  <tr style="border:1px solid #dcdcdc;">
		    <td style="border:1px solid #dcdcdc;" width="100px">累计销售额（元）</td>
		    <td style="border:1px solid #dcdcdc;" width="100px">累计销售笔数（笔）</td>
		    <td style="border:1px solid #dcdcdc;" width="100px">客户在投总额（元）</td>
		  </tr>
		</table>
		<br>
	<div class="row">
...
<br>
		<table style="border:1px solid #dcdcdc;">
		  <tr style="border:1px solid #dcdcdc;">
		    <td style="border:1px solid #dcdcdc;" width="100px">客户销售佣金（元）</td>
		    <td style="border:1px solid #dcdcdc;" width="100px">理财师推荐奖励（元）</td>
		    <td style="border:1px solid #dcdcdc;" width="100px">活动奖励（元）</td>
		    <td style="border:1px solid #dcdcdc;" width="100px">leader奖励（元）</td>
		    <td style="border:1px solid #dcdcdc;" width="100px">累计收益（元）</td>
		  </tr>
		</table>
...
<!-- <div class="row">
			<div class="col-sm-8">备注：</div>
		</div>	
		<div class="row">
			<div class="col-sm-8">1、理财师历史累计收益中包含用户已发放和待发放收益的总和。</div>
		</div>	
		<div class="row">
			<div class="col-sm-8">2、理财师收益明细中，如果该月份的收益包含已发放和未发放，则显示结果为各收益分类待发放和已发放收益的总和。</div>
		</div>	
 -->
...
<div class="row">
		<div class="uk-blank"></div>
		<div class="row">
			<div class="col-sm-6"><span>客户人数：</span><span><a class="ui-redirect" data-title="客户人数" data-url="rest/lcsList/customelist/${dtl.mobile}">${dtl.customerCount}</a></span></div>
			<div class="col-sm-6"></div>
		</div>
		<div class="uk-blank"></div>
		<div class="row">
			<div class="col-sm-6"><span>团队人数：</span><span><a class="ui-redirect" data-title="团队人数" data-url="rest/lcsList/teamlist?mobile=${dtl.mobile}">${dtl.teamMemberCount}</a></span></div>
			<div class="col-sm-6"></div>
		</div>
...
<script type="text/javascript">
	...
	function getLcsDetailSalesInfo(mobile){
		var data = {};
        data.mobile = mobile;
		//alert(data.mobile);
        $.post('rest/lcsList/getLcsDetailSalesInfo',data, function(data, textStatus) {
          $("#salesInfo").html(data);
          });
     }
	
	 $(document).ready(function() {
		 getLcsDetailSalesInfo("${dtl.mobile}")
	 });
