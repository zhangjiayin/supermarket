			...
			<div class="col-sm-10"><!-- 小屏幕  ≥768px-->
					...
					<div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-5">
	                             <c:choose> 
									  <c:when test="${orgInfo.orgUrlSkipJumpType == 0}">
									  	<input type="text" class="form-control"  value="直接跳转第三方" readonly="readonly" />
									  </c:when> 
									  <c:when test="${orgInfo.orgUrlSkipJumpType == 1}">   
									   	<input type="text" class="form-control"  value="跳转本地机构详情页" readonly="readonly" />  
									  </c:when> 
								</c:choose> 
	                          </div>
	                      </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgWithdrawDepositUrl" value="${orgInfo.orgWithdrawDepositUrl}"  readonly="readonly" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgRechargeUrl" value="${orgInfo.orgRechargeUrl}"  readonly="readonly" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipIndex" value="${orgInfo.orgUrlSkipIndex}"  readonly="readonly" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipProductBuyRecord" value="${orgInfo.orgUrlSkipProductBuyRecord}"  readonly="readonly" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipRechargeRecord" value="${orgInfo.orgUrlSkipRechargeRecord}"  readonly="readonly" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipWithdrawDepositRecord" value="${orgInfo.orgUrlSkipWithdrawDepositRecord}"  readonly="readonly" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipSafeCenter" value="${orgInfo.orgUrlSkipSafeCenter}"  readonly="readonly" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipActivity" value="${orgInfo.orgUrlSkipActivity}"  readonly="readonly" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipBankcardRechargeLimit" value="${orgInfo.orgUrlSkipBankcardRechargeLimit}"  readonly="readonly" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipOfficialNotice" value="${orgInfo.orgUrlSkipOfficialNotice}"  readonly="readonly" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipProductBuyCompact" value="${orgInfo.orgUrlSkipProductBuyCompact}"  readonly="readonly" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipRedpackage" value="${orgInfo.orgUrlSkipRedpackage}"  readonly="readonly" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipCoupon" value="${orgInfo.orgUrlSkipCoupon}"  readonly="readonly" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipConcessionScore" value="${orgInfo.orgUrlSkipConcessionScore}"  readonly="readonly" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>	                  
