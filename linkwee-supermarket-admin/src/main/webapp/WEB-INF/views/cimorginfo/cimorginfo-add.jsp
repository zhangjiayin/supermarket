				    ...
				    <div class="col-md-8">
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-5">
	                               <input type="text" class="form-control required" name="orgNumber" autocomplete="off" placeholder="机构编码根据机构名称全拼生成" readonly="readonly"/>
	                          </div>
	                          <!-- 
	                 ...
	                 <div class="col-md-8 fill">
						<div class="form-group">
							...
							<div class="col-md-6">
								<input class="uploadImg"  type="file" id="shareIcon" />
								<!-- 上传成功存入隐藏域中 -->
								<input name="shareIcon" type="hidden" required="required" />
							</div>
						</div>
					</div>
					...
					<div class="col-md-8">	
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="shareTitle"  autocomplete="off"  style="width: 600px;" required="required" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="shareLink"  autocomplete="off"  style="width: 600px;" required="required" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="shareDesc" autocomplete="off"  style="width: 600px;" required="required" />
	                          </div>
	                      </div>
	                  </div>
