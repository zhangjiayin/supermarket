	...
	<form id="orgForm" action="/rest/cim/cimorginfo/update" method="post">
		<div class="row">
			...
			<div class="col-sm-10"><!-- 小屏幕  ≥768px-->
			 		...
			 		<input type="hidden" name="orgUrlSkipJumpType" value="${orgInfo.orgUrlSkipJumpType}" /> <!-- 机构详情跳转类型 -->
			 		<input type="hidden" name="orgProductUrlSkipBindType" value="${orgInfo.orgProductUrlSkipBindType}" /> <!-- 平台产品跳转绑卡类型 -->
				    ...
				    <div class="col-md-8">
	                  ...
	                  <div class="col-md-8">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-5">
	                               <input type="text" class="form-control required" id="orgNumber" name="orgNumber" value="${orgInfo.orgNumber}" autocomplete="off" placeholder="请输入机构名称大写全拼" readonly="readonly" />
	                          </div>
	                      </div>
	                  </div>
	              ...
	              <div class="col-md-8">
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">平台注意事项：</label>
	                          <div class="col-md-5">
	                               <input type="text" class="form-control" name="orgFeeRatioLimit" value="${orgInfo.orgFeeRatioLimit}" autocomplete="off" placeholder="输入的内容将显示在产品详情页顶部，作为平台/产品的提示信息" style="width: 600px;" maxlength="40" />
	                          </div>
	                      </div>
	                  </div>
					...
					<div class="col-md-8">	
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-5">
	                               <textarea id="orgWebsiteRecords" class="ueditorPlug" name="orgWebsiteRecords" style="width: 800px;height: 500px">${orgInfo.orgWebsiteRecords}</textarea>
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-5">
	                               <textarea id="orgContactDetails" class="ueditorPlug" name="orgContactDetails" style="width: 800px;height: 500px">${orgInfo.orgContactDetails}</textarea>
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
		               ...
		               <div class="col-md-8">
					 		<div class="form-group">
						        <label class="control-label col-md-3">平台产品跳转前是否需先绑卡：</label>
						        <span  class="span-hint">设置跳转前需先绑卡(ON)</span>
								 <div class="switch col-md-3">
									<input type="checkbox" id="orgProductUrlSkipBindType" data-name="orgProductUrlSkipBindType" class="bootstrapSwitch" <c:if test="${orgInfo.orgProductUrlSkipBindType == 1}">checked</c:if> />
								</div>
						    </div>
					    </div>	                  
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUserbalanceUrl" value="${orgInfo.orgUserbalanceUrl}" autocomplete="off" placeholder="请输入用户资产余额查询接口地址" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                ...
	                <div class="col-md-8">
				 		<div class="form-group">
					        <label class="control-label col-md-3">机构详情跳转类型：</label>
					        <span  class="span-hint">设置跳转本地机构详情页(ON)</span>
							 <div class="switch col-md-3">
								<input type="checkbox" id="orgUrlSkipJumpType" data-name="orgUrlSkipJumpType" class="bootstrapSwitch" <c:if test="${orgInfo.orgUrlSkipJumpType == 1}">checked</c:if> />
							</div>
					    </div>
				    </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">机构提现跳转地址：</label>
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgWithdrawDepositUrl" value="${orgInfo.orgWithdrawDepositUrl}" autocomplete="off" placeholder="请输入机构提现跳转地址（可选）" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">机构充值跳转地址：</label>
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgRechargeUrl" value="${orgInfo.orgRechargeUrl}" autocomplete="off" placeholder="请输入机构充值跳转地址（可选）" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">机构首页链接地址：</label>
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipIndex" value="${orgInfo.orgUrlSkipIndex}" autocomplete="off" placeholder="请输入机构首页链接地址（可选）" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">机构产品购买记录链接：</label>
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipProductBuyRecord" value="${orgInfo.orgUrlSkipProductBuyRecord}" autocomplete="off" placeholder="请输入机构产品购买记录链接（可选）" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">机构充值记录链接：</label>
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipRechargeRecord" value="${orgInfo.orgUrlSkipRechargeRecord}" autocomplete="off" placeholder="请输入机构充值记录链接（可选）" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">机构提现记录链接：</label>
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipWithdrawDepositRecord" value="${orgInfo.orgUrlSkipWithdrawDepositRecord}" autocomplete="off" placeholder="请输入机构提现记录链接（可选）" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">机构安全中心详情页链接：</label>
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipSafeCenter" value="${orgInfo.orgUrlSkipSafeCenter}" autocomplete="off" placeholder="请输入机构安全中心详情页链接（可选）" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">机构活动列表页面链接：</label>
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipActivity" value="${orgInfo.orgUrlSkipActivity}" autocomplete="off" placeholder="请输入机构活动列表页面链接（可选）" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">机构平台银行充值限额表链接：</label>
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipBankcardRechargeLimit" value="${orgInfo.orgUrlSkipBankcardRechargeLimit}" autocomplete="off" placeholder="请输入机构平台银行充值限额表链接（可选）" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">机构官方公告列表链接：</label>
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipOfficialNotice" value="${orgInfo.orgUrlSkipOfficialNotice}" autocomplete="off" placeholder="请输入机构官方公告列表链接（可选）" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">机构产品购买后电子合同链接：</label>
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipProductBuyCompact" value="${orgInfo.orgUrlSkipProductBuyCompact}" autocomplete="off" placeholder="请输入机构产品购买后电子合同链接（可选）" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">机构红包链接：</label>
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipRedpackage" value="${orgInfo.orgUrlSkipRedpackage}" autocomplete="off" placeholder="请输入机构红包链接（可选）" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">机构优惠券链接：</label>
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipCoupon" value="${orgInfo.orgUrlSkipCoupon}" autocomplete="off" placeholder="请输入机构优惠券链接（可选）" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">机构积分链接：</label>
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="orgUrlSkipConcessionScore" value="${orgInfo.orgUrlSkipConcessionScore}" autocomplete="off" placeholder="请输入机构积分链接（可选）" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">安全保障<span style="color: red;">*</span>：</label>
	                          <div class="col-md-5">
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">发标时间：</label>
	                          <div class="col-md-5">
	                               <textarea id="productReleaseTime" name="productReleaseTime" style="width: 600px;height: 100px;">${orgInfo.productReleaseTime}</textarea>
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">充值限制(描述)：</label>
	                          <div class="col-md-5">
	                               <textarea id="rechargeLimitDescription" name="rechargeLimitDescription" style="width: 600px;height: 100px;">${orgInfo.rechargeLimitDescription}</textarea>
	                          </div>
	                      </div>
	                  </div>
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">充值限制(标题)：</label>
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="rechargeLimitTitle" value="${orgInfo.rechargeLimitTitle}" autocomplete="off" placeholder="充值限制(标题)" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">充值限制(链接)：</label>
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="rechargeLimitLinkUrl" value="${orgInfo.rechargeLimitLinkUrl}" autocomplete="off" placeholder="充值限制(链接)" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div>
	                  <%-- <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">充值限制(详情)：</label>
	                          <div class="col-md-9">
	                               <input type="text" class="form-control" name="rechargeLimitDetail" value="${orgInfo.rechargeLimitDetail}" autocomplete="off" placeholder="充值限制(详情)" style="width: 600px;" />
	                          </div>
	                      </div>
	                  </div> --%>
	                  ...
	                  <div class="col-md-8 fill">
	                  	<div class="form-group">
	                          <label class="control-label col-md-3">充值限制(详情)：</label>
				                <div class="row">
									 <div class="col-md-4">
									  	 <input  id="rechargeLimitDetailFile" class="form-control" type="file" name="rechargeLimitDetailFile" />
									</div>
									<label class="col-md-4 control-label">
										 <span style="color: ;font-size: 10px;">请点击下载<a href="/rest/cim/cimorginfo/downloadRechargeLimitExcelTemplate">《模板》</a>，仅支持xls文件，最大10000条.</span>
									</label>								
								</div>	
								<div class="row">
									<div class="col-md-2 col-md-offset-12">
									 	<a class="btn btn-danger J_importRechargeLimitDetail"  role="button" >导入</a>
									 </div>
								</div>							
						</div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">起息时间：</label>
	                          <div class="col-md-5">
	                               <textarea id="interestTime" name="interestTime" style="width: 600px;height: 100px;">${orgInfo.interestTime}</textarea>
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">提现费用：</label>
	                          <div class="col-md-5">
	                               <textarea id="withdrawalCharges" name="withdrawalCharges" style="width: 600px;height: 100px;">${orgInfo.withdrawalCharges}</textarea>
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">提现到账时间：</label>
	                          <div class="col-md-5">
	                               <textarea id="cashInTime" name="cashInTime" style="width: 600px;height: 100px;">${orgInfo.cashInTime}</textarea>
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          <label class="control-label col-md-3">其他（投资相关）：</label>
	                          <div class="col-md-5">
	                               <textarea id="investOthers" name="investOthers" style="width: 600px;height: 100px;">${orgInfo.investOthers}</textarea>
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-5">
	                               <textarea id="orgInvestStrategy" class="ueditorPlug" name="orgInvestStrategy" style="width: 800px;height: 500px">${orgInfo.orgInvestStrategy}</textarea>
	                          </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="col-md-8 fill">
	                      <div class="form-group">
	                          ...
	                          <div class="col-md-5">
	                               <textarea id="orgPlannerStrategy" class="ueditorPlug" name="orgPlannerStrategy" style="width: 800px;height: 500px">${orgInfo.orgPlannerStrategy}</textarea>
	                          </div>
	                      </div>
	                  </div>
...
$(document).ready(function() {
 	...
 	$(".J_importRechargeLimitDetail").click(function() {
 		var file = $('#rechargeLimitDetailFile').val(); //获取文件名
 		...
 		formData.append('file', $('#rechargeLimitDetailFile')[0].files[0]);
 		formData.append('orgNumber', $('#orgNumber').val());
 		$.ajax({
 	 		    url: './rest/cim/cimorginfo/importRechargeLimitDetail',
 	 		    type: 'POST',
 	 		    cache: false,
 	 		    data: formData,
 	 		    processData: false,
