...
<input type="hidden" value="${pushItem.id }" name="id">
			...
			<br>
			<div class="row">
				<label class="col-sm-2 control-label">推送对象(1理财师,2投资人):</label>
				<div class="col-md-4">
					<input type="radio" value="1" id="appType" <c:if test="${pushItem.appType == 1 || empty pushItem}">checked="checked"</c:if>   name="appType">理财师 
					<input type="radio" value="2" id="appType" <c:if test="${pushItem.appType == 2 }">checked="checked"</c:if> name="appType">投资者
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<input type="radio" value="0" id="pushTypeOne" <c:if test="${pushItem.pushType == 0 }">checked="checked"</c:if>   name="pushType">通知栏+消息中心
					<input type="radio" value="1" id="pushTypeTwo" <c:if test="${pushItem.pushType == 1 || empty pushItem}">checked="checked"</c:if> name="pushType">仅通知栏
				    <input type="radio" value="2" id="pushTypeThree" <c:if test="${pushItem.pushType == 2 }">checked="checked"</c:if> name="pushType">仅消息中心
				</div>
			</div>
			
<!-- 			<br> -->
<!-- 			<div class="row" id="pushTitle"> -->
<!-- 				<label class="col-sm-2 control-label">推送标题:</label> -->
<!-- 				<div class="col-md-4"> -->
<%-- 					  <input type="text" class="form-control" name="title" autocomplete="off" placeholder="推送内容" value="${pushItem.title }"/> --%>
<!-- 				</div> -->
<!-- 			</div> -->
			...
			<br>
			<div class="row" id="link" style="display:block;">
...
<!-- 			<br> -->
<!-- 			<div class="row" id="msgTitle"  style="display:none;"> -->
<!-- 				<label class="col-sm-2 control-label">消息中心标题:</label> -->
<!-- 				<div class="col-md-4"> -->
<%-- 					  <input type="text" class="form-control" name="msgTitle" autocomplete="off" placeholder="推送内容" value="${pushItem.msgTitle }"/> --%>
<!-- 				</div> -->
<!-- 			</div> -->
			
<!-- 			<br> -->
<!-- 			<div class="row"  id="msgContent"  style="display:none;"> -->
<!-- 				<label class="col-sm-2 control-label">消息中心内容:</label> -->
<!-- 				<div class="col-md-4"> -->
<%-- 					  <input type="text" class="form-control" name="msgContent" autocomplete="off" placeholder="推送内容" value="${pushItem.msgContent }"/> --%>
<!-- 				</div> -->
<!-- 			</div> -->
			...
			<div class="row">
				...
				<div class="col-md-4">
					  <input type="text" class="form-control" name="startTime" value="<fmt:formatDate value="${pushItem.startTime}" pattern="yyyy-MM-dd HH" />" autocomplete="off" placeholder="定时发送时必填，即时发送可不填" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH'})"/>
				</div>
			</div>
			</div>
			
			<br>
			<div class="row" id="sendObjectTypeId" style="display:block;">
				...
				<div class="col-md-4">
					...
					<input type="radio" value="1"  name="sendObjectType" id = "sendObjectType_import" <c:if test="${pushItem.sendObjectType == 1 || pushItem.pushType ==2 }">checked="checked"</c:if> >指定用户
				</div>
			</div>
			<br>
...
$(document).ready(function() {
	//点击推送方式显示内容
	$("#pushTypeOne").click(function() {
		$("#link").show();
		$("#import_file_div").hide();
 	});
	
	$("#pushTypeTwo").click(function() {
		$("#link").show();
		$("#import_file_div").hide();
 	});
	
	$("#pushTypeThree").click(function() {
		$("#link").hide();
		$("#import_file_div").hide();
 	});
	...
	//开始推送
 	$(".J_sendRedpacket").click(function() {
 		...
 		if(startTime == "" && startType == 1){
 			layer.msg("定时发送时间不能为空！",{time: 2000,icon: 0});
			return;
 		}
