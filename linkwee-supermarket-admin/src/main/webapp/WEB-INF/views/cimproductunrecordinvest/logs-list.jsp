...
<script type="text/javascript" src="app/cimproductunrecordinvest/logs-list.js"></script>
<!-- 管理员才有下列权限 -->
...
<!-- layer弹层组件 -->
 ...
 <script type="text/template" id="template-search">
		<div class="row">
          	  <div class="col-xs-8 ">
			        <form>
                        <input type="text" name="investTime" id="investTime" style="width:130px" class="easyui-textbox" placeholder="请选择上传时间" />
