...
<div id="main-news" class="container-fluid">
    ...
    <script type="text/javascript">
        ...
        var doFCT = function (data,type,full,meta) {
	        ...
	        var edit = '<button class="btn btn-sm btn-default btn-icon J_productSale_detail" data-title="销售明细" data-productId='+full.productId+' data-productName='+full.productName+' "><i class="fa fa-search-plus"></i>销售明细</button>';
            return edit;
        }
