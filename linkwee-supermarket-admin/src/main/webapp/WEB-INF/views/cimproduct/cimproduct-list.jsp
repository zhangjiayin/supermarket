...
<div id="main-news" class="container-fluid">
    ...
    <script type="text/javascript">
        ...
        var doFCT = function (data,type,full,meta) {
	        ...
	        var edit = '<button class="btn btn-sm btn-default btn-icon J_productEdit" data-title="产品编辑" data-id='+full.id+' data-productId='+full.productId+' data-hotIndex="'+full.hotIndex+'" data-showIndex="'+full.showIndex+'" ><i class="fa fa-edit" ></i>编辑</button>';
            return edit;
        }
    ...
    <script type="text/linkwee-template" id="template-search">
          	<div class="row">
				...
				<shiro:hasPermission name="<%=PermissionSign.PRODUCT_BATCH_CHECK%>">
