 ...
 */
@Component
public class RecommendedFeedProfitCalculation extends AbstractProfitCalculation{
	...
	protected Boolean preCalculate(CrmInvestor investor, CrmCfplanner cfplanner,InvestRecordWrapper investRecord, FeedetailWrapper feedetailWrapper) {
		...
		feedetailWrapper.setRatio(levelRewardRate.getRecommendRate().doubleValue());
		...
		if(StringUtils.isBlank(remark)){
			...
			remark = StringUtils.join(new Object[]{remark,"推荐津贴"}, "-");
		}
