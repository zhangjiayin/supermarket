...
public class PinyinTool {  
    ...
    public static void main(String[] args) throws BadHanyuPinyinOutputFormatCombination {
    	...
    	System.out.println(pinyin.toPinYin("明天ABC"));
    	System.out.println(pinyin.toPinYin("长沙市长"));
    	System.out.println(pinyin.toPinYin("长沙市长","*"));
    	System.out.println(pinyin.toPinYin("E周行"));
    	System.out.println(pinyin.toPinYin("E周行","_"));
    	System.out.println(pinyin.toPinYin("E周行","_",PinyinTool.Type.LOWERCASE));
	}
}  
