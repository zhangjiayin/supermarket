...
public class CuratorZookeeperClient {
			...
			curator.getConnectionStateListenable().addListener(new ConnectionStateListener() {
				public void stateChanged(CuratorFramework client, ConnectionState state) {
					if (state == ConnectionState.LOST) {
						...
						//连接重连
						for(CuratorZookeeperStateListener s:stateListeners){
							s.reconnected();
						}
					}
				}
	...
	private final Set<CuratorZookeeperStateListener> stateListeners = new CopyOnWriteArraySet<CuratorZookeeperStateListener>();
	public void addStateListener(CuratorZookeeperStateListener listener) {
