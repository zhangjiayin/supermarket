...
public class CrmCfplannerServiceImpl extends GenericServiceImpl<CrmCfplanner, Long> implements CrmCfplannerService{
	...
	@Override
	public void updatejobgradeByTime(String startTime, String endTime) {
		// TODO Auto-generated method stub
		crmCfplannerMapper.updatejobgradeByTime(startTime,endTime);
	}

	@Override
	public void updatejobgradeByUserId(CrmCfpLevelRecord crmCfpLevelRecord) {
		// TODO Auto-generated method stub
		crmCfplannerMapper.updatejobgradeByUserId(crmCfpLevelRecord.getUserId(),crmCfpLevelRecord.getCurLevel(),crmCfpLevelRecord.getCurLevelWeight());
	}

	@Override
	public Map<String, Integer> queryJobgradeCount(String userId) {
		// TODO Auto-generated method stub
		Map<String, Integer> returnMap = new HashMap<String, Integer>();
		List<JobgradeCount> JobgradeCountList = crmCfplannerMapper.queryJobgradeCount(userId);
		for (JobgradeCount jobgradeCount : JobgradeCountList) {
			returnMap.put(jobgradeCount.getJobGrade(), jobgradeCount.getAmount());
		}
		return returnMap;
	}
	
	@Override
	public Map<String, Integer> queryJobgradeTempCount(String userId) {
		// TODO Auto-generated method stub
		Map<String, Integer> returnMap = new HashMap<String, Integer>();
		List<JobgradeCount> JobgradeCountList = crmCfplannerMapper.queryJobgradeTempCount(userId);
		for (JobgradeCount jobgradeCount : JobgradeCountList) {
			returnMap.put(jobgradeCount.getJobGrade(), jobgradeCount.getAmount());
		}
		return returnMap;
	...
	@Override
	public int queryJobgradeCountByType(String userId, String jobGrade) {
		return crmCfplannerMapper.queryJobgradeCountByType(userId,jobGrade);
	}

	@Override
	public void updatejobgradeTempByUserId(CrmCfpLevelRecordTemp crmCfpLevelRecordTemp) {
		crmCfplannerMapper.updatejobgradeTempByUserId(crmCfpLevelRecordTemp.getUserId(),crmCfpLevelRecordTemp.getCurLevel(),crmCfpLevelRecordTemp.getCurLevelWeight());
	}

	@Override
	public void initJobgrade() {
		crmCfplannerMapper.initJobgrade();
	}

	@Override
	public void initJobgradeTemp() {
		// TODO Auto-generated method stub
		crmCfplannerMapper.initJobgradeTemp();
	}
