...
public class CrmUserInfoServiceImpl extends GenericServiceImpl<CrmUserInfo, Long> implements CrmUserInfoService{
	...
	@Override
	public List<CrmUserInfo> getUserInfoByFundOrderTime(GetOrderUserInfoRequest getOrderUserInfoRequest) {
		// TODO Auto-generated method stub
		return crmUserInfoMapper.getUserInfoByFundOrderTime(getOrderUserInfoRequest);
	}

	@Override
	public List<CrmUserInfo> queryUserListByMobileListAppType(Integer appType, String dayTime) {
		return crmUserInfoMapper.queryUserListByMobileListAppType(appType,dayTime);
	}
