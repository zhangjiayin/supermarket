...
public interface CfplannerManagerService {
	 ...
	 * @return
	 */
	public LcsDetailSalesInfoResp queryLcsDetailSalesInfoResp(String mobile);
	 ...
	 * @return
	 */
	public DataTableReturn queryCfpLevelList(CfpManagerDetailResp detailResp,DataTable dataTable);
