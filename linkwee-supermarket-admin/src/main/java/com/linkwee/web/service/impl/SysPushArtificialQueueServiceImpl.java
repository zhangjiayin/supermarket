...
public class SysPushArtificialQueueServiceImpl extends GenericServiceImpl<SysPushArtificialQueue, Long> implements SysPushArtificialQueueService{
	...
	public DataTableReturn selectByDatatables(DataTable dt) {
		...
		String msgPushPermission = "0";
		if(currentUser.isPermitted(PermissionSign.MSG_PUSH_EDIT)) {
			msgPushPermission = "1";
		}
		for(SysPushArtificialQueue temp : list){			
			temp.setMsgPushPermission(msgPushPermission);					
		}
