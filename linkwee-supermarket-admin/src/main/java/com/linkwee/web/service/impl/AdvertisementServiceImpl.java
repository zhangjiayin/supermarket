...
public class AdvertisementServiceImpl implements AdvertisementService{
	...
	@Override
	public boolean hasDuplicateProductOpening(Date validBeginDate,Date validEndDate,String advId) {
		List<SmAdvertisement> advertisementList = smAdvertisementMapper.duplicateProductOpening(DateUtils.format(validBeginDate, DateUtils.FORMAT_LONG),DateUtils.format(validEndDate, DateUtils.FORMAT_LONG),advId);
