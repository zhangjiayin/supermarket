...
import com.linkwee.web.service.impl.CimOrgRechargeLimitServiceImpl;
...
public class CimOrgRechargeLimitServiceImpl extends GenericServiceImpl<CimOrgRechargeLimit, Long> implements CimOrgRechargeLimitService{
	...
	@Override
	public void batchInsert(List<CimOrgRechargeLimit> insertList) {
		cimOrgRechargeLimitMapper.batchInsert(insertList);
	}

	@Override
	public void deleteOrgRechargeLimitBefore(String orgNumber) {
		cimOrgRechargeLimitMapper.deleteOrgRechargeLimitBefore(orgNumber);		
	}
