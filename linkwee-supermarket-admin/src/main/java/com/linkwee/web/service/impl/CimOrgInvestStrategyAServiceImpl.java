...
public class CimOrgInvestStrategyAServiceImpl extends GenericServiceImpl<CimOrgInvestStrategyA, Long> implements CimOrgInvestStrategyAService{
   ...
   public DataTableReturn selectByDatatables(DataTable dt) {
    ...
    @Override
    public void batchUpdateInvestStrategy(List<CimOrgInvestStrategyA> investStrategys) {
        cimOrgInvestStrategyAMapper.batchUpdateInvestStrategy(investStrategys);
    }

    @Override
    public void insertBatch(List<CimOrgInvestStrategyA> newInvestStrategys) {
        cimOrgInvestStrategyAMapper.insertBatch(newInvestStrategys);
    }
