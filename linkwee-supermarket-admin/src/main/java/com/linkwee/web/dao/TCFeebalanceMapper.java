...
public interface TCFeebalanceMapper extends GenericDao<TCFeebalance,Long>{
	 ...
	 * @return
	 */
	FeeSummaryResponse getSummary(@Param("bizId") String bizId);
	 ...
	 * @return
	 */
	boolean isSummary(@Param("bizId") String bizId,@Param("type") Integer type);
	
	int updateFeeSummary(@Param("bizId") String bizId);
