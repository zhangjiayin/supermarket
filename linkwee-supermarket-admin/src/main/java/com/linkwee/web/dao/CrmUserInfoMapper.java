...
public interface CrmUserInfoMapper extends GenericDao<CrmUserInfo,Long>{
	...
	/**
	 * 根据基金下单日期 查询用户的基本信息
	 * @param getOrderUserInfoRequest
	 * @return
	 */
	List<CrmUserInfo> getUserInfoByFundOrderTime(GetOrderUserInfoRequest getOrderUserInfoRequest);
	 ...
	 * @return
	 */
	List<CrmUserInfo> queryUserListByMobileListAppType(@Param("appType")Integer appType, @Param("dayTime")String dayTime);
