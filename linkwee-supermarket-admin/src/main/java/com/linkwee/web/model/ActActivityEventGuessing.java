...
* @创建人： Hxb
*
* @创建时间：2018年05月24日 10:13:55
*
* Copyright (c) 深圳领会科技有限公司-版权所有
*/
public class ActActivityEventGuessing implements Serializable {

   private static final long serialVersionUID = -2743642528958496834L;
   ...
   public void setGuessingName(String guessingName){
       this.guessingName = guessingName;
   }

   public String getGuessingName(){
       return guessingName;
   }
