...
public class CimOrginfoWeb implements Serializable {
	 ...
	 * 机构收费模式权限
	 */
	private String feeModelEditPermission;
	/**
	 * 机构佣金权限
	 */
	private String feeEditPermission;
	/**
	 * 是否首笔同时计算cpa+cps
	 */
	...
	public String getFeeModelEditPermission() {
		return feeModelEditPermission;
	}

	public void setFeeModelEditPermission(String feeModelEditPermission) {
		this.feeModelEditPermission = feeModelEditPermission;
	}

	public String getFeeEditPermission() {
		return feeEditPermission;
	}

	public void setFeeEditPermission(String feeEditPermission) {
		this.feeEditPermission = feeEditPermission;
	}
