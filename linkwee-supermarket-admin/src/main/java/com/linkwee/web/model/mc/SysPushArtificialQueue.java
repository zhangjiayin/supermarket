...
public class SysPushArtificialQueue implements Serializable {
	 ...
	 * 信息推送新增删除权限
	 */
	private String msgPushPermission;
	...
	public String getMsgPushPermission() {
		return msgPushPermission;
	}

	public void setMsgPushPermission(String msgPushPermission) {
		this.msgPushPermission = msgPushPermission;
	}
}
