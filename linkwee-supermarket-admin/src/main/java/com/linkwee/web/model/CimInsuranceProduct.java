...
public class CimInsuranceProduct implements Serializable {
	 ...
	 * 保险推荐种类
	 */
	private List<CimInsuranceRecommendName> cimInsuranceRecommendNameList;
	...
	public List<CimInsuranceRecommendName> getCimInsuranceRecommendNameList() {
		return cimInsuranceRecommendNameList;
	}

	public void setCimInsuranceRecommendNameList(
			List<CimInsuranceRecommendName> cimInsuranceRecommendNameList) {
		this.cimInsuranceRecommendNameList = cimInsuranceRecommendNameList;
	}
}
