 ...
 */
public class CrmCfpLevelRecordTemp implements Serializable {
	
	private static final long serialVersionUID = -179336384248640230L;
	...
	public void setCurLevel(String curLevel){
		...
		this.curLevelWeight = CfpJobGradeEnum.getCfpJobGradeEnumByKey(curLevel).getLevelWeight();
	}
