...
public class CfpAchievementResp extends BaseEntity {
	 ...
	 * 投资平台首投
	 */
	private String platformFirstInvest;
	/**
	 * T呗首投
	 */
	private String toobeiFirstInvest;
	...
	public String getPlatformFirstInvest() {
		return platformFirstInvest;
	}
	public void setPlatformFirstInvest(String platformFirstInvest) {
		this.platformFirstInvest = platformFirstInvest;
	}
	public String getToobeiFirstInvest() {
		return toobeiFirstInvest;
	}
	public void setToobeiFirstInvest(String toobeiFirstInvest) {
		this.toobeiFirstInvest = toobeiFirstInvest;
	}
