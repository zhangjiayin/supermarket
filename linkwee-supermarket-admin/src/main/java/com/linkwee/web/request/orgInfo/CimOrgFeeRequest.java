...
public class CimOrgFeeRequest implements Serializable {
	...
	public String getCpaAndCpsType() {
		return cpaAndCpsType;
	}


	public void setCpaAndCpsType(String cpaAndCpsType) {
		this.cpaAndCpsType = cpaAndCpsType;
	}
