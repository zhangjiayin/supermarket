...
public class RedpacketTemplateListResponse extends BaseEntity{
    ...
    */
	 ...
	 * 回款自动派发红包新增编辑绑定机构权限
	 */
	private String repaymentRedpacketPermission;
...
public String getRepaymentRedpacketPermission() {
	return repaymentRedpacketPermission;
}



public void setRepaymentRedpacketPermission(String repaymentRedpacketPermission) {
	this.repaymentRedpacketPermission = repaymentRedpacketPermission;
}
