...
/*	@RequestMapping("list_json")
	...
	@RequestMapping("stickNum")
	@ResponseBody
	public Object stickNum(@RequestParam String appType ){
		int result = newsService.stickNum(appType);
		return result;
	}
		
	@RequestMapping("stickUpdate")
	@ResponseBody
	public Object stickUpdate(@RequestParam String id, @RequestParam String isStick){
		ResponseResult result = null;
		ReturnCode returnCode = newsService.stickUpdate(id,isStick);
		if(returnCode.getCode() == 0){
