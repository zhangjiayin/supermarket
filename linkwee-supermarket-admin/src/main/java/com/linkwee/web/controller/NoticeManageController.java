...
public class NoticeManageController {
    ...
    */
    ...
    @ResponseBody
    @RequestLogging("公告管理用户权限")
	public Map<String, String> getUserPermission() {
    	Map<String, String> resultMap = new HashMap<String, String>();
    	Subject currentUser = SecurityUtils.getSubject();
		String noticeEditPermission = "0";
		if(currentUser.isPermitted(PermissionSign.NOTICE_EDIT)) {
			noticeEditPermission = "1";
		}
		resultMap.put("noticeEditPermission", noticeEditPermission);
    	return resultMap;
	}
