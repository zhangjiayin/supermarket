...
public class SmFeedbackController {
    ...
    @ResponseBody
    @RequestLogging("意见反馈用户权限")
	public Map<String, String> getUserPermission() {
    	Map<String, String> resultMap = new HashMap<String, String>();
    	Subject currentUser = SecurityUtils.getSubject();
		String feebackEditPermission = "0";
		if(currentUser.isPermitted(PermissionSign.FEEDBACK_EDIT)) {
			feebackEditPermission = "1";
		}
		resultMap.put("feebackEditPermission", feebackEditPermission);
    	return resultMap;
	}
