...
public class OrgSaleFeeStatController {
	...
	@RequestMapping("/noreturn_amount")
	@ResponseBody
	public Object queryNoReturnAmount(OrgSaleFeeListRequest req) throws Exception{
		Map<String, Object> params = getQueryParams(req);
		Double investAmout = cimOrgFeedetailService.queryNoReturnAmount(params);
		return investAmout == null ? 0 : investAmout;
	}
