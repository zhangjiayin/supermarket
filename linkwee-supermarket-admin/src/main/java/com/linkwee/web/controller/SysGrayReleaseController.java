...
public class SysGrayReleaseController {
    ...
    @ResponseBody
    @RequestLogging("灰度管理用户权限")
	public Map<String, String> getUserPermission() {
    	Map<String, String> resultMap = new HashMap<String, String>();
    	Subject currentUser = SecurityUtils.getSubject();
		String grayEditPermission = "0";
		if(currentUser.isPermitted(PermissionSign.GRAY_EDIT)) {
			grayEditPermission = "1";
		}
		resultMap.put("grayEditPermission", grayEditPermission);
    	return resultMap;
	}
