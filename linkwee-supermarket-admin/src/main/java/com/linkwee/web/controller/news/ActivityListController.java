...
public class ActivityListController {
	...
	@Resource
	private CimOrgInfoAService orgInfoAService;
    ...
    public ModelAndView activityList(Model model) {
		...
		List<OrgNameNumber> activityPlatformListNames = orgInfoAService.queryAllOrgNameNumber(1);
	...
	public Object update(@Valid ActivityListRequest act,BindingResult bindResult){
		...
		try {
			...
			if(jedisCluster != null){//若redis存在
				String redisOrgKey = act.getActivityPlatform() + "_platform_detail_org_activity";
