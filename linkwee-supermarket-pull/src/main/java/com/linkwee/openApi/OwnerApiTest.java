...
public class OwnerApiTest {
	...
	public void accountBind(){
		...
		//发送请求
		OpenApiCommonUtils.httpRequest(orgEnum,orgRequestType,orgBaseUrl+"/account/bind",parameters);
	}
	...
	public void accountAssert(){
		...
		parameters.put("mobile", "13417322420");
		//发送请求
		OpenApiCommonUtils.httpRequest(orgEnum,orgRequestType,orgBaseUrl+"/account/assert",parameters);
	...
	public void personal(){
		...
		//发送请求
		OpenApiCommonUtils.httpRequest(orgEnum,orgRequestType,orgBaseUrl+"/oms/personal",parameters);
	...
	public void product(){
		...
		parameters.put("requestFrom", "wap");
		//发送请求
		OpenApiCommonUtils.httpRequest(orgEnum,orgRequestType,orgBaseUrl+"/oms/product",parameters);
	}
	...
	public void testIsExistInPlatform(){
		...
		parameters.put("mobile", "13417322420");
		//发送请求
		OpenApiCommonUtils.httpRequest(OrgEnum.OPEN_LUJINSUO_WEB,RequestTypeEnums.GET,"http://10.16.4.77/lh_api/account/isexist",parameters);
	}
}
