...
public class PlatformContentRouter extends RouterConverter {
	...
	public String converter(String target, HttpServletRequest request, HttpServletResponse response) {
		...
		if("pc".equals(moduleName)) moduleName = "article";
		if (TemplateManager.me().currentTemplateModule(moduleName) != null) {
			return Consts.ROUTER_CONTENT_PLATFORM + target.replace("pc",moduleName);
		}
