...
import io.jpress.model.base.BasePlatform;
...
@Table(tableName = "platform", primaryKey = "id")
...
/*	public List<Taxonomy> getTaxonomys() {
	...
	public String getUrl() {
		String baseUrl = null;
		if (Consts.MODULE_PLATFORM.equals(this.getModule())) {
			baseUrl = PlatformRouter.getRouter(this);
		} else {
			baseUrl = PlatformRouter.getRouter(this);
		}
	...
	public String getUrlWithPageNumber(int pagenumber) {
		return PlatformRouter.getRouter(this, pagenumber);
	}
