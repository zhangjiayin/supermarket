...
public class JHandler extends Handler {
	...
	public void handle(String target, HttpServletRequest request, HttpServletResponse response, boolean[] isHandled) {
		...
		request.setAttribute("JPRESS_WEBSITE", OptionQuery.me().findValue("jpress_website"));
		request.setAttribute("PC_IMG_WEBSITE", OptionQuery.me().findValue("pc_img_website"));
