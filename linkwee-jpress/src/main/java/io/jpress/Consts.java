...
public class Consts {
	...
	public static final String ROUTER_PLATFORM = "/p";
	...
	public static final String ROUTER_CONTENT_PLATFORM = "/pc";
	...
	public static final String MODULE_PLATFORM = "platform"; // 平台档案模型
