...
public class AdminMenuInitListener implements MessageListener {
	...
	public void initModuleMenuGroup(MenuManager menuMnager) {
		...
		for (TplModule module : modules) {
			...
			if(module.getName().equals("platform")){
				group.addMenuItem(new MenuItem("list", "/admin/platform?m=" + module.getName(), module.getListTitle()));
				group.addMenuItem(new MenuItem("edit", "/admin/platform/edit?m=" + module.getName(), module.getAddTitle()));
			}else{
