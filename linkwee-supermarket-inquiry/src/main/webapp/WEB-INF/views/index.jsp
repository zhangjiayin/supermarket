                    ...
                    <ul class="page-sidebar-menu" id="page-sidebar-menu">
                       ...
                       <li class="start active">
                           <a href="javascript:;">
                               ...
                               <ul class="sub-menu">
                                                   <li>
                                                       <a href="rest/orgsalefee/init" default="javascript:;" id="btn-dashboard"/>
                                                          	 总体数据
                                                       </a>
                                                   </li>
                                                   <li>
                                                       <a href="rest/cim/cimproduct/salesStatistics" default="javascript:;"/>
                                                           	产品销售
                                                       </a>
                                                   </li>
                                                   <li>
                                                       <a href="rest/invest/init" default="javascript:;"/>
                                                         	 投资用户
                                                       </a>
                                                   </li>
                               </ul>
                       ...
                       <li class="">
                           <a href="javascript:;">
                               <i class="fa fa-money"></i><span class="title"> 我的产品</span><span class="arrow "> </span>
                           </a>
                               <ul class="sub-menu">
                                                   <li>
                                                       <a href="rest/cim/cimproduct/list" default="javascript:;"/>
                                                          	 产品列表
                                                       </a>
                                                   </li>
                               </ul>
