...
<link rel="shortcut icon" href="app/img/favicon.ico"/>
	<style type="text/css">
		html,body{ height: 100%; width: 100%; background-color: #BACEFE; overflow: hidden;}
		.login{background-color: #BACEFE !important; }
		.login .content{ background-color: #ffffff;box-shadow: 5px 0px 20px #3958A2;
			border-top-left-radius:2em !important;
			-webkit-border-top-left-radius:2em !important;
		}
		.login .content h3,.login .content h4{ color: #666;}
		.login .logo{ margin-top: 150px !important;}
	</style>
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
...
<div class="content">
	...
	<form class="login-form" action="rest/auth/login" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input name="orgAccount" id="orgAccount" size="25" value="" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="用户名" />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input name="orgPassword" id="orgPassword" size="25" value="" class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="密码" />
			</div>
		</div>
		<div class="form-actions">
			<span style="line-height: 34px; color: #666;">请不要在公共场所登录系统</span>
	...
	<form class="register-form" action="index.html" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				<i class="fa fa-user"></i>
				<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="用户名" name="orgAccount"/>
			</div>
		</div>
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">密码</label>
