 ...
 */
public enum RepaymentRecordStatus {
	...
	private RepaymentRecordStatus(String type, String desc) {
		this.type = type;
		this.desc = desc;
	}
	...
	public static RepaymentRecordStatus getEnum(String code) {
		RepaymentRecordStatus[] arr = RepaymentRecordStatus.values();
		for (RepaymentRecordStatus tmp : arr) {
