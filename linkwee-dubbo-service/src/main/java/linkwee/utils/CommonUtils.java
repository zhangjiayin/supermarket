...
public class CommonUtils {
	 ...
	 * @param commonRlt
	 */
	public static <T> void checkAccountCenterResponse(CommonRlt<T> commonRlt){
		if(commonRlt.getReturnCode() != 0){
			LOGGER.error("基础平台-账户中心：returnCode={} returnMsg={}",commonRlt.getReturnCode(),commonRlt.getReturnMsg());
		}
	}
	 ...
	 * @param commonRlt
	 */
	public static <T> void checkSmsCenterResponse(SmsResult<T> smsResult){
		if(smsResult.getReturnCode() != 0){
			LOGGER.info("基础平台-短信中心：returnCode={} returnMsg={}",smsResult.getReturnCode(),smsResult.getReturnMsg());
		}
	}
	 ...
	 * @param commonRlt
	 */
	public static <T> void checkUserCenterResponse(cn.xn.user.domain.CommonRlt<T> commonRlt){
		if(commonRlt.getReturnCode() != 0){
			LOGGER.info("基础平台-用户中心：returnCode={} returnMsg={}",commonRlt.getReturnCode(),commonRlt.getReturnMsg());
		}
	}
}
